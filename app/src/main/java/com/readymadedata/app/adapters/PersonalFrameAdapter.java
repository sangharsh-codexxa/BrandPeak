...
public class PersonalFrameAdapter extends RecyclerView.Adapter<PersonalFrameAdapter.MyViewHolder> {
    int column;
    ...
    public PersonalFrameAdapter(Context context2, ClickListener<Integer> listener2, int column2, float width2) {
